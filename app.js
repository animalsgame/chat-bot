...
function isBelki(){
if(bot.botInfo && bot.botInfo.app==2)return true;
return false;
}
...
// bot.run() удалён из кода, в нём больше нет необходимости
...
if(isBelki()){
// если белки, указываем другой список id подарков, список можно получить в окне "подарочная коробка" в игре
ids=[1,54,287];
}
